...
# 构建模型
model = ARIMA(train_y, order=(0, 1, 1), exog=train_x)
...
pd.DataFrame(simulation).to_excel('simulation_ARIMA-case2.xlsx')
pd.DataFrame(forecast).to_excel('forecast_ARIMA-case2.xlsx')
pd.DataFrame(APE1).to_excel('APE_ARIMA1-case2.xlsx')
pd.DataFrame(APE2).to_excel('APE_ARIMA2-case2.xlsx')