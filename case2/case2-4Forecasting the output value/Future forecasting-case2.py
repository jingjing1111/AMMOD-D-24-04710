...
# 配置超参数
zeta, tau, gamma = 0.15307665, 0.26199854, 0.42348471

# 读取数据
data = pd.read_excel("data/case2_prediction_data_begin2014.xlsx")
...
print("hat_x0: \n")
for year, i in zip(range(2015, 2027), hat_x0):
    print(year, i)
pd.DataFrame(hat_x0).to_excel('case2-future forecasting.xlsx')
